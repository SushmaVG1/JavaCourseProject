...
public class PhotographyDeleteOption extends JFrame {

	private JPanel contentPane;

	@SuppressWarnings({ "unchecked", "rawtypes" })
	public PhotographyDeleteOption() {
		...
		comboBox.setModel(new DefaultComboBoxModel(Main.photographyName()));
		comboBox.setBounds(313, 224, 314, 57);
		comboBox.setBackground(SystemColor.controlLtHighlight);
		contentPane.add(comboBox);

		JLabel lblNewLabel = new JLabel("Photography services available");
		lblNewLabel.setBounds(313, 107, 302, 57);
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Main.arrayPhotography.remove(comboBox.getSelectedIndex());
				...
				try {
					...
					String query = "delete from photography where name = '" + data + "'";

...
public class ViewServicesHome extends JFrame {

	private JPanel contentPane;

	public ViewServicesHome() {
		...
		btnPhotography.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				ViewPhotography v = new ViewPhotography();
				v.setVisible(true);
				dispose();
			}
		});
		...
		btnCaterer.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				ViewCatering v = new ViewCatering();
				v.setVisible(true);
				dispose();
			}
		});
		...
		btnBack.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				UserOptionsPage a = new UserOptionsPage();
				a.setVisible(true);
				dispose();
			}
		});
		...
		JLabel lblNewLabel = new JLabel("View Service Provider");

...
public class ThemeDeleteOption extends JFrame {

	private JPanel contentPane;

	@SuppressWarnings({ "unchecked", "rawtypes" })

	public ThemeDeleteOption() {
		...
		comboBox.setModel(new DefaultComboBoxModel(Main.themeName()));
		comboBox.setBounds(313, 224, 314, 57);
		comboBox.setBackground(SystemColor.controlLtHighlight);
		contentPane.add(comboBox);

		JLabel lblNewLabel = new JLabel("Themes Available");
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Main.arrayTheme.remove(comboBox.getSelectedIndex());
				...
				try {
					...
					String query = "delete from theme where name = '" + data + "'";

...
public class AddVenue extends JFrame {
	...
	public AddVenue() {
		...
		JLabel lblNewLabel = new JLabel("Enter the venue details to be added");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel.setBounds(415, 60, 314, 52);
		...
		JButton btnNewButton = new JButton("Add Venue");
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (!name.equals("") && !address.equals("") && !phNo.equals("") && !email.equals("")) {
					try {
						...
						if (charges >= 5000) {
							Venue p = new Venue(name, address, phNo, email, charges);
							Main.arrayVenue.add(p);
							try {
								...
								String query = "insert into venue values('" + name + "', '" + email + "' , '" + address
										+ "','" + phNo + "', " + charges + ")";
							...
							JOptionPane.showMessageDialog(null, "Minimum charges for venue is Rs. 5000");
					} catch (Exception ep) {
		...
		btnNewButton.setBounds(509, 573, 97, 25);
